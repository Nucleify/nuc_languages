...
const { editValues, originalValues, isChanged, resetSingle, initItems } =
  useTranslationEdit('nuxt')

const changedCount = computed(() =>
  countChangedTranslations(editValues.value, originalValues.value)
)
...
const {
  ...
  onPageChange,
  onSearchEnter,
} = useTranslationFetch('nuxt', initItems)
